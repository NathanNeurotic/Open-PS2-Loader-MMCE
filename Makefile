...
# labels this fork added, without ever touching lng_src/ (which tools/dependencies/download_lng.sh rewrites).
...
LANG_COMPILER = tools/languages/lang_compiler.py

languages: $(ENGLISH_TEMPLATE_YML) $(TRANSLATIONS_YML) $(ENGLISH_LNG) $(TRANSLATIONS_LNG) $(INTERNAL_LANGUAGE_C) $(INTERNAL_LANGUAGE_H)

download_lng:
	./tools/dependencies/download_lng.sh

download_lwNBD:
	./tools/dependencies/download_lwNBD.sh

download_cfla:
	./tools/dependencies/download_cfla.sh
