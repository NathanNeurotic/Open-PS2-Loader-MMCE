...
- [PS1 VCD support](VCD.md)
- [Theme engine](THEME_ENGINE.md)

## Design work

- [Ember integration plan](EMBER-INTEGRATION-PLAN.md)

## Historical reports

These documents record the state at the time of their original audits. Their
branch names, source line numbers, conclusions, and work instructions are
historical context and must be checked against current code before reuse.
