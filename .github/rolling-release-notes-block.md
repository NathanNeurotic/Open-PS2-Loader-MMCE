...
PS1 titles run through **two** cores, and both appear together in a single **PS1** list. Press
**L3** on a device page to swap between your PS2 discs and that PS1 list.
