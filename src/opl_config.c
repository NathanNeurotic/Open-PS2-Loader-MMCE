...
static void _loadConfig()
{
    ...
    if (lscstatus & CONFIG_OPL) {
        ...
        if (result & CONFIG_OPL) {
            ...
            configGetStrCopy(configOPL, CONFIG_OPL_ETH_PREFIX, gNetworkConfig.eth_prefix, sizeof(gNetworkConfig.eth_prefix));
            ...
            configGetInt(configOPL, CONFIG_OPL_ETH_MODE, &gNetworkConfig.eth_start_mode);
...
static void _saveConfig()
{
    ...
    if (lscstatus & CONFIG_OPL) {
        ...
        configSetStr(configOPL, CONFIG_OPL_ETH_PREFIX, gNetworkConfig.eth_prefix);
        ...
        configSetInt(configOPL, CONFIG_OPL_ETH_MODE, gNetworkConfig.eth_start_mode);
